...
$(function () {
    ...
    $(document).on('click', '.del-cat-btn', function () {
        deleteCategory($(this).data('cat-del'));
    });
    $(document).on('click', '.del-prod-btn', function () {
        deleteProduct($(this).data('prod-del'));
    });
    $(document).on('click', '.del-photo-btn', function () {
        deleteProductPhoto($(this).data('photo-id'));
    });
    $(document).on('click', '#applyVoucherCodeBtn', function () {
        applyVoucherCode();
    });
    $(document).on('click', '.remove-coupon-btn', function () {
        removeVoucher($(this).data('coupon-code'));
    });
});
    ...
    $.ajax({
        ...
        success: function success(data) {
            if (data.status == 'success') {
                ...
                $("#applied-coupons table").append('<tr id="cc_' + data.code + '">' + '<th>' + data.code + ': </th>' + '<td>' + data.value + ' BM</td>' + '<td>' + '<button type="button" class="btn btn-danger btn-xs remove-coupon-btn" data-coupon-code="' + data.code + '">' + '<span class="glyphicon glyphicon-trash"></span>' + '</button>' + '</td>' + '</tr>');
