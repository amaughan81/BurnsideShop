            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '192.168.0.11')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'OU=Establishments,DC=bbec,DC=internal'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'webmaster'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'W@||$3nD'),
